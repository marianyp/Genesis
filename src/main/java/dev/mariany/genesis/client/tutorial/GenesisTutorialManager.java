...
public class GenesisTutorialManager {
    private final MinecraftClient client;
    @Nullable
    private TutorialStepHandler currentHandler;

    public GenesisTutorialManager(MinecraftClient client) {
        this.client = client;
    }
    ...
    public void createHandler() {
        ...
        this.currentHandler = GenesisTutorialState.getInstance().step.createHandler(this);
    }
    ...
    public void setStep(GenesisTutorialStep step) {
        if (this.currentHandler != null) {
            this.currentHandler.destroy();
    ...
    public boolean isInSurvival() {
        return this.client.interactionManager != null &&
                this.client.interactionManager.getCurrentGameMode() == GameMode.SURVIVAL;
    }
